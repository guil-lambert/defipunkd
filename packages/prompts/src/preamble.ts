...
11. chat_url, when included, must be a publicly-reachable shareable URL of the chat session that produced this assessment (claude.ai/share/..., chatgpt.com/share/..., g.co/gemini/share/..., etc.). The quorum bot gives extra weight to submissions with a verifiable chat_url because the reasoning chain is independently re-readable. Optional but strongly recommended.
...
13. Before assigning a grade other than "unknown", your rationale must include a one-sentence steel-man for each of the three plausible grades (red / orange / green), then state which one best fits the evidence and why. The format is:
